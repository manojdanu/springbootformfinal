...
<body class="container-fluid" style="background-color:rgb(153, 196, 150);">
    <div>
            ...
            <button class="navbar-toggler " type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup"
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-item nav-link color-me" href="/">SaveData</a>
                        <a class="nav-item nav-link color-me" href="/search">SearchData</a>
                        <a class="nav-item nav-link color-me" href="/update">UpdateData</a>
                        <a class="nav-item nav-link color-me" href="/delete">DeleteData</a>
    ...
    <div class="container mt-3">
        <form action="/update" method="post">
            ...
            <div class=" container form-group text-dark">
               <div class="row-sm-2" style="text-align:center">
                    <h2><label for="phone" class="font-weight-bold col-form-label">*Phone Number*</label> </h2>
                </div>
            ...
            <div class="form-group row bg-light">
                ...
                <div class="col-sm-2">
                 ...
                 <label for="name" class="col-sm-2 font-weight-bold col-form-label ">Full Name:</label>
                <div class="col-sm-6">
